...
//  WUSTLNutrition
//
//  Created by labuser on 10/10/17.
...
class LocationTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
       ...
       self.navigationController?.navigationBar.tintColor = FlatWhite()
        ...
        //for location in foodsByLocation.keys {
        //    foodsByLocation[location]? = (foodsByLocation[location]?.removeDuplicates())!
        //}
        //self.tableView.register(LocationTableViewCell, forCellReuseIdentifier: "LocationTableViewCell")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            //let destination = LocationTableViewController()
            ...
            //print(destination.selectedLocation!)
